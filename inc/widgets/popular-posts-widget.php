...
class onepageshop_popular_posts_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function onepageshop_popular_posts_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'onepageshop_tabbed_widget', 'description' => __('Displays tabbed list of popular posts, recent posts & comments', 'onepageshop') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'onepageshop_tabbed_widget' );

		/* Create the widget. */
		parent::__construct( 'onepageshop_tabbed_widget', __('onepageshop: Popular Posts Widget', 'onepageshop'), $widget_ops, $control_ops );
	}
        ...
        <div class="widget tabbed">
            <div class="tabs-wrapper">
                <ul class="nav nav-tabs">
                      <li class="active"><a href="#popular-posts" data-toggle="tab"><?php _e('Popular', 'onepageshop') ?></a></li>
                      <li><a href="#recent" data-toggle="tab"><?php _e('Recent', 'onepageshop') ?></a></li>
            ...
            <div class="tab-content">
                ...
                <?php foreach($recent_comments as $comment) : ?>
                    ...
                    <li>
                        <div class="content">
                            <?php if ( $comment->comment_author ) { echo $comment->comment_author; } else { _e('Anonymous','onepageshop'); } ?> <?php _e('on','onepageshop'); ?>
	...
	function form( $instance ) {
		...
		<!-- Number of posts -->
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e('Number of posts to show','onepageshop') ?>:</label>
