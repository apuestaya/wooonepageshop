<?php
/**
 * onepageshop Meta Boxes
 *
 */

add_action('add_meta_boxes', 'onepageshop_add_custom_box');
/**
 * Add Meta Boxes.
 *
 * Add Meta box in page and post post types.
 */
function onepageshop_add_custom_box()
{
    add_meta_box('siderbar-layout', //Unique ID
        __('Select layout for this specific Page only ( Note: This setting only reflects if page Template is set as Default Template and Blog Type Templates.)', 'onepageshop'), //Title
        'onepageshop_sidebar_layout', //Callback function
        'page' //show metabox in pages
        );
    add_meta_box('siderbar-layout', //Unique ID
        __('Select layout for this specific Post only', 'onepageshop'), //Title
        'onepageshop_sidebar_layout', //Callback function
 ...
 */
function onepageshop_sidebar_layout()
{
...
add_action('save_post', 'onepageshop_save_custom_meta');
/**
 * save the custom metabox data
 * @hooked to save_post hook
 */
function onepageshop_save_custom_meta($post_id)
{
    global $site_layout, $post;
